...
class MainActivity : AppCompatActivity() {
    ...
    private fun modelAdapter(){
        val movies = listOf<MovieModel>(
            MovieModel(1, "DETEKTIF JAGA JARAK (2023)", R.drawable.gambar1),
            MovieModel(2, "SPIRIT DOLL (2023)", R.drawable.gambar2),
            MovieModel(3, "KUTUKAN SEMBILAN SETAN (2023)", R.drawable.gambar3),
            MovieModel(4, "STAR SYNDROME (2023)", R.drawable.gambar4),
            MovieModel(5, "SOSOK KETIGA (2023)", R.drawable.gambar5),
            MovieModel(6, "ONDE MANDE (2023)", R.drawable.gambar6),
            MovieModel(7, "GANJIL GENAP (2023)", R.drawable.gambar7),
        )
